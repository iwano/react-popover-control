...
var PopoverActionsType = _react.PropTypes.arrayOf(_react.PropTypes.shape({
...
var PopoverList = (function (_React$Component2) {
  ...
  _createClass(PopoverList, [{
    ...
    value: {
      actions: PopoverActionsType.isRequired,
      delegate: _react.PropTypes.shape({
        shouldHidePopover: _react.PropTypes.func.isRequired,
        getPopoverReferenceFrame: _react.PropTypes.func.isRequired
      }).isRequired,
      windowMargin: _react.PropTypes.number.isRequired,
      launcherMargin: _react.PropTypes.number.isRequired
    },
    enumerable: true
  }, {
    key: 'defaultProps',
